...
$jumlah = select("SELECT COUNT(*) AS jumlah_konfirmasi
                    ...
                    WHERE t.status = 'dalam pengiriman'");
            ...
            <div class="mdk-drawer-layout__content page-content">
                ...
                <div class="page-section">
                    <div class="container page__container">
                        <h1 class="text-center">Dalam Pengiriman</h1>
                        <?php foreach ($jumlah as $jml) : ?>
                            <h6>Terdapat <?= $jml['jumlah_konfirmasi']; ?> pesanan yang dalam pengiriman</h6>
                        <?php endforeach; ?>
                        <!-- TERIMA ORDER -->
