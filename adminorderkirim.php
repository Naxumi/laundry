...
$data_konfirmasi = select("SELECT 
                            ...
                            WHERE 
                                (t.jenis_id = 2 AND t.status = 'disetrika') 
                                OR (t.jenis_id != 2 AND t.status = 'dicuci')");
            ...
            <div class="mdk-drawer-layout__content page-content">
                ...
                <div class="page-section">
                    <div class="container page__container">
                        <h1 class="text-center">Kirim Pesanan</h1>
                        <?php foreach ($jumlah as $jml) : ?>
                            <h6>Terdapat <?= $jml['jumlah_konfirmasi']; ?> pesanan yang belum dikirim</h6>
                        <?php endforeach; ?>
                        <!-- TERIMA ORDER -->
                                                ...
                                                <div class="flex">
                                                    ...
                                                    <form action="" class="col-md-5  mx-auto p-0" method="POST">
                                                        ...
                                                        <div class="form-group d-flex justify-content-end">
                                                            ...
                                                            <button type="submit" name="action" value="terima" class="btn btn-success">Kirim</button>
                                                        </div>
                                                    </form>
                                                </div>
                                            </div>
