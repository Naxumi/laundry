...
$data_client = select("SELECT * FROM client ORDER BY client_id ASC");
            ...
            <div class="mdk-drawer-layout__content page-content">
                ...
                <div class="page-section">
                    <div class="container page__container">
                        <h2>Data Client</h1>
                        <p>Lihat informasi semua client</p>
                        <a href="admin_crudclient_tambah.php">
                        ...
                        <div class="table-responsive">
                            <table id="example" class="table mb-0 thead-border-top-0 table-nowrap" style="width:100%">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>
                                            <a href="admin_crudclient_ubah.php?client_id=<?= $client['client_id']; ?>" class="text-secondary font-weight-bold text-xs px-2" data-bs-toggle="tooltip" data-bs-title="Edit">
                                            ...
                                            <a href="admin_crudclient_hapus.php?client_id=<?= $client['client_id']; ?>" class="text-secondary font-weight-bold text-xs" data-bs-toggle="tooltip" data-bs-title="Delete">
