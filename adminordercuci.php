            ...
            <div class="mdk-drawer-layout__content page-content">
                ...
                <div class="page-section">
                    <div class="container page__container">
                        <h1 class="text-center">Cuci Pesanan</h1>
                        <?php foreach ($jumlah as $jml) : ?>
                            <h6>Terdapat <?= $jml['jumlah_konfirmasi']; ?> pesanan yang belum dikonfirmasi</h6>
                        <?php endforeach; ?>
                        <!-- TERIMA ORDER -->
                                                ...
                                                <div class="flex">
                                                    ...
                                                    <form action="" class="col-md-5  mx-auto p-0" method="POST">
                                                        ...
                                                        <div class="form-group d-flex justify-content-end">
                                                            ...
                                                            <button type="submit" name="action" value="terima" class="btn btn-success">Cuci</button>
                                                        </div>
                                                    </form>
                                                </div>
                                            </div>
