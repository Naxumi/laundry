...
$data_jenis = select("SELECT * FROM jenislaundry ORDER BY jenis_id ASC");
            ...
            <div class="mdk-drawer-layout__content page-content">
                ...
                <div class="page-section">
                    <div class="container page__container">
                        <h2>Data Jenis Laundry</h1>
                        <p>Lihat informasi semua jenis laundry</p>
                        <a href="admin_crudjenislaundry_tambah.php">
                        ...
                        <div class="table-responsive">
                            <table id="example" class="table mb-0 thead-border-top-0 table-nowrap" style="width:100%">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>
                                            <a href="admin_crudjenislaundry_ubah.php?jenis_id=<?= $jenis['jenis_id']; ?>" class="text-secondary font-weight-bold text-xs px-2" data-bs-toggle="tooltip" data-bs-title="Edit">
                                            ...
                                            <a href="admin_crudjenislaundry_hapus.php?jenis_id=<?= $jenis['jenis_id']; ?>" class="text-secondary font-weight-bold text-xs" data-bs-toggle="tooltip" data-bs-title="Delete">
