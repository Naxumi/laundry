...
$data_petugas = select("SELECT * FROM petugas ORDER BY petugas_id ASC");
            ...
            <div class="mdk-drawer-layout__content page-content">
                ...
                <div class="page-section">
                    <div class="container page__container">
                        <h2>Data Petugas</h1>
                        <p>Lihat informasi semua petugas</p>
                        <a href="admin_crudpetugas_tambah.php">
                        ...
                        <div class="table-responsive">
                            <table id="example" class="table mb-0 thead-border-top-0 table-nowrap" style="width:100%">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>
                                            <a href="admin_crudpetugas_ubah.php?petugas_id=<?= $petugas['petugas_id']; ?>" class="text-secondary font-weight-bold text-xs px-2" data-bs-toggle="tooltip" data-bs-title="Edit">
                                            ...
                                            <a href="admin_crudpetugas_hapus.php?petugas_id=<?= $petugas['petugas_id']; ?>" class="text-secondary font-weight-bold text-xs" data-bs-toggle="tooltip" data-bs-title="Delete">
